...
class Outputer (BaseModel):
    ...
    def output_comment(self, comment):
        ...
        self._output.write(f"\n{indent}{self._comment_mark} {lines[0]}\n")
        for line in lines[1:]:
            self._output.write(f"{indent}{self._comment_mark} {line}\n")
    ...
    def output_header(self):
        ...
        if self.common_comment:
            self.output_comment(self.common_comment)
...
class Python3Outputer (Outputer):
    ...
    def output_enum(self, enum : Enum):
        self._output.write(f"class {enum.name}(int, Enum):\n")
